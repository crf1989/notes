...
\begin{equation}
  ...
  \end{array}
\end{equation}
For static conductivity, we have (it must be emphasized that there is
a extra factor 2 since there is no oscillation during the time
average)
\begin{equation}
  \lim_{\omega\to0}\Re\,\sigma(\omega)=
  \frac{2e^2\hbar}{\pi V}\int dE
